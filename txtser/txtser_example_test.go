...
func ExampleRBuffer() {
	...
	// Output:
	// header: txtser.Header{Version:0x13, Flags:0x108040804}
	// bool: false
	// bool: true
	// int8: 0x11
	// int16: 0x2222
...
func ExampleRBuffer_32bits() {
	...
	// Output:
	// header: txtser.Header{Version:0x13, Flags:0x108040404}
	// bool: false
	// bool: true
	// int8: 0x11
	// int16: 0x2222
...
func ExampleEncoder_32b() {
	buf := new(bytes.Buffer)
	enc := txtser.Arch32.NewEncoder(buf)
